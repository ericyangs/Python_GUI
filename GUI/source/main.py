...
TX_Serial = serial.Serial(port ='COM22', baudrate = 9600, parity = serial.PARITY_NONE, stopbits = serial.STOPBITS_ONE, bytesize = serial.EIGHTBITS, timeout = 0)
###############################################################################
...
class MyWindow(QMainWindow, form_class):
    ...
    def hit_btn_clicked(self):
        ...
        TX_Serial.write(bytes("9\n", encoding ='ascii'))
    def EE_btn_clicked(self):
        print ("EE") # for debug
        TX_Serial.write(bytes("4\n", encoding='ascii'))
    def NE_btn_clicked(self):
        print ("NE") # for debug
        TX_Serial.write(bytes("7\n", encoding='ascii'))
    def NN_btn_clicked(self):
        print ("NN") # for debug
        TX_Serial.write(bytes("1\n", encoding='ascii'))
    def NW_btn_clicked(self):
        print ("NW") # for debug
        TX_Serial.write(bytes("5\n", encoding='ascii'))
    def SE_btn_clicked(self):
        print ("SE") # for debug
        TX_Serial.write(bytes("8\n", encoding='ascii'))
    def SS_btn_clicked(self):
        print ("SS") # for debug
        TX_Serial.write(bytes("2\n", encoding='ascii'))
    def SW_btn_clicked(self):
        print ("SW") # for debug
        TX_Serial.write(bytes("6\n", encoding='ascii'))
    def WW_btn_clicked(self):
        print ("WW") # for debug
        TX_Serial.write(bytes("3\n", encoding='ascii'))
###############################################################################
###############################################################################
